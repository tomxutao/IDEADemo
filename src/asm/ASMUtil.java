...
public class ASMUtil {
    ...
    static MethodVisitor getMethodVisitor(String[] interfaces, String className, String superName,
        ...
        if (name.equals("onClick") && isMatchingInterfaces(interfaces, "android/view/View$OnClickListener")) {
            System.out.println("xutaoxutao123 ASMUtil.getMethodVisitor() visitMethod * onClick");
            ...
            System.out.println("xutaoxutao123 ASMUtil.getMethodVisitor() visitMethod * onResume");
            if (className.contains("Fragment") && superName.contains("Fragment")) {
                System.out.println("xutaoxutao123 ASMUtil.getMethodVisitor() visitMethod * onResume in Fragment");
                adapter = new CarlMethodVisitor(methodVisitor, access, name, desc) {
                    @Override
                ...
                System.out.println("xutaoxutao123 ASMUtil.getMethodVisitor() visitMethod * onResume in Activity");
                adapter = new CarlMethodVisitor(methodVisitor, access, name, desc) {
                    @Override
                    protected void onMethodExit(int opcode) {
                        super.onMethodExit(opcode);
            ...
            System.out.println("xutaoxutao123 ASMUtil.getMethodVisitor() visitMethod * onPause");
            if (className.contains("Fragment") && superName.contains("Fragment")) {
                System.out.println("xutaoxutao123 ASMUtil.getMethodVisitor() visitMethod * onPause in Fragment");
                adapter = new CarlMethodVisitor(methodVisitor, access, name, desc) {
                    @Override
                    protected void onMethodExit(int opcode) {
                        super.onMethodExit(opcode);
                ...
                System.out.println("xutaoxutao123 ASMUtil.getMethodVisitor() visitMethod * onPause in Activity");
                adapter = new CarlMethodVisitor(methodVisitor, access, name, desc) {
                    @Override
                    protected void onMethodExit(int opcode) {
                        super.onMethodExit(opcode);
